...
public:
    ...
    QLabel *labelPortfel;
    QLabel *labelWymiana;
    QComboBox *comboBoxWalutaL;
    QComboBox *comboBoxWalutaR;
    QDoubleSpinBox *doubleSpinBoxKwota;
    QPushButton *pushButtonWymien;
    QPushButton *pushButtonWykresy;
    QWidget *pageWykresy;
    QPushButton *pushButtonPowrot;
    QComboBox *comboBoxWaluta;
    QPushButton *pushButtonRysuj;
    QGraphicsView *graphicsViewWykres;
    QMenuBar *menubar;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButtonWyloguj->setGeometry(QRect(600, 20, 150, 50));
        pushButtonWyloguj->setFont(font);
        ...
        labelWymiana = new QLabel(pageProfil);
        labelWymiana->setObjectName(QStringLiteral("labelWymiana"));
        labelWymiana->setGeometry(QRect(480, 200, 171, 31));
        labelWymiana->setFont(font2);
        comboBoxWalutaL = new QComboBox(pageProfil);
        comboBoxWalutaL->setObjectName(QStringLiteral("comboBoxWalutaL"));
        comboBoxWalutaL->setGeometry(QRect(400, 250, 100, 40));
        comboBoxWalutaL->setFont(font);
        comboBoxWalutaR = new QComboBox(pageProfil);
        comboBoxWalutaR->setObjectName(QStringLiteral("comboBoxWalutaR"));
        comboBoxWalutaR->setGeometry(QRect(520, 250, 100, 40));
        comboBoxWalutaR->setFont(font);
        doubleSpinBoxKwota = new QDoubleSpinBox(pageProfil);
        doubleSpinBoxKwota->setObjectName(QStringLiteral("doubleSpinBoxKwota"));
        doubleSpinBoxKwota->setGeometry(QRect(640, 250, 100, 40));
        doubleSpinBoxKwota->setFont(font);
        pushButtonWymien = new QPushButton(pageProfil);
        pushButtonWymien->setObjectName(QStringLiteral("pushButtonWymien"));
        pushButtonWymien->setGeometry(QRect(480, 300, 180, 40));
        QFont font4;
        font4.setFamily(QStringLiteral("Calibri"));
        font4.setPointSize(16);
        pushButtonWymien->setFont(font4);
        pushButtonWykresy = new QPushButton(pageProfil);
        pushButtonWykresy->setObjectName(QStringLiteral("pushButtonWykresy"));
        pushButtonWykresy->setGeometry(QRect(440, 400, 260, 71));
        pushButtonWykresy->setFont(font);
        stackedWidget->addWidget(pageProfil);
        pageWykresy = new QWidget();
        pageWykresy->setObjectName(QStringLiteral("pageWykresy"));
        pushButtonPowrot = new QPushButton(pageWykresy);
        pushButtonPowrot->setObjectName(QStringLiteral("pushButtonPowrot"));
        pushButtonPowrot->setGeometry(QRect(600, 20, 150, 50));
        pushButtonPowrot->setFont(font);
        comboBoxWaluta = new QComboBox(pageWykresy);
        comboBoxWaluta->setObjectName(QStringLiteral("comboBoxWaluta"));
        comboBoxWaluta->setGeometry(QRect(275, 475, 100, 40));
        comboBoxWaluta->setFont(font);
        pushButtonRysuj = new QPushButton(pageWykresy);
        pushButtonRysuj->setObjectName(QStringLiteral("pushButtonRysuj"));
        pushButtonRysuj->setGeometry(QRect(425, 475, 100, 40));
        pushButtonRysuj->setFont(font);
        graphicsViewWykres = new QGraphicsView(pageWykresy);
        graphicsViewWykres->setObjectName(QStringLiteral("graphicsViewWykres"));
        graphicsViewWykres->setGeometry(QRect(100, 100, 600, 350));
        stackedWidget->addWidget(pageWykresy);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        labelWymiana->setText(QApplication::translate("MainWindow", "Wymiana walut", Q_NULLPTR));
        pushButtonWymien->setText(QApplication::translate("MainWindow", "Wymie\305\204", Q_NULLPTR));
        pushButtonWykresy->setText(QApplication::translate("MainWindow", "Wykresy kurs\303\263w walut", Q_NULLPTR));
        pushButtonPowrot->setText(QApplication::translate("MainWindow", "Powr\303\263t", Q_NULLPTR));
        pushButtonRysuj->setText(QApplication::translate("MainWindow", "Rysuj", Q_NULLPTR));
    } // retranslateUi
